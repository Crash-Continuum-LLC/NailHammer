...
impl generated::dispatch::Operators for Interp {
    ...
    fn assign(
        &mut self,
        place: generated::place::Place<'_, Reg>,
        value: Reg,
    ) -> nh_runtime::Result<Reg> {
        use generated::place::Place;
        match place {
            Place::PrimaryVar { name, .. } => Ok(self.write_var(name, value)),
        }
    }

    fn place_read(&mut self, place: &generated::place::Place<'_, Reg>) -> nh_runtime::Result<Reg> {
        use generated::place::Place;
        match place {
